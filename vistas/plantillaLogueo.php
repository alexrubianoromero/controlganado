...
<body id="divInicialInventarios">
    ...
    <div id ="div_principal_inventarios">
        <div>
            <div align="center" class="mt-3">
                <img height="350px"   src="imagenes/imagen.jpg" style="border-radius:50%"> 
                <H2 class="mt-3">CATÁLOGO GANADERO</H2></div>
            </div>
            <div class="row">
    ...
    <script src="dist/js/adminlte.min.js"></script>
        ...
        <script src="facturas/js/facturas.js"></script>  
        <script src="ganado/js/ganado.js"></script>  
        <script>
